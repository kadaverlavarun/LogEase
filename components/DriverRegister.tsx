...
const DriverRegister: React.FC<DriverRegisterProps> = ({ onRegisterSuccess, onSwitchToLogin }) => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10">
      <Card>
        <div className="p-8">
          <h2 className="text-2xl font-bold text-center text-gray-800 dark:text-white mb-2">Driver Registration</h2>
          <p className="text-center text-gray-500 dark:text-gray-400 mb-6">Create your driver account</p>
